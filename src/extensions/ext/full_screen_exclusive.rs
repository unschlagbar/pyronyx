...
pub trait FullScreenExclusiveDevice {
    ...
    fn acquire_full_screen_exclusive_mode(&self, swapchain: SwapchainKHR) -> Result<(), vkResult>;

    fn release_full_screen_exclusive_mode(&self, swapchain: SwapchainKHR) -> Result<(), vkResult>;
}
